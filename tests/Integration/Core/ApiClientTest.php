...
final class ApiClientTest extends TestCase
{
    public function testFooo(): void
    {
        ...
        $factory = ServiceFactory::fromEnvironment($logger);

        var_dump($factory->getQueueService()->getQueueInfo());

        var_dump($factory->getStatusService()->getFileStatus('ac2f86c6-1910-4673-baef-667bd7f0c724'));

        var_dump($factory->getTranscriptionService()->getTranscript('ac2f86c6-1910-4673-baef-667bd7f0c724'));


        var_dump(
            file_put_contents(
                'tests/Temp/tr_1.txt',
                $factory->getTranscriptionService()->getTranscript('ac2f86c6-1910-4673-baef-667bd7f0c724')->getResult()
            )
        );
